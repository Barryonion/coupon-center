package com.barry.coupon.template.service;
...
import com.barry.coupon.template.api.enums.CouponType;
import com.barry.coupon.template.converter.CouponTemplateConverter;
import com.barry.coupon.template.dao.CouponTemplateDao;
...
public class CouponTemplateServiceImpl implements CouponTemplateService {
    ...
    public CouponTemplateInfo createTemplate(CouponTemplateInfo request) {
        ...
        if (request.getShopId() != null) {
            ...
            if (count >= 100) {
                log.error("the totals of coupon template exceeds maximal number");
                throw new UnsupportedOperationException("exceeded the maximal coupon templates that you can create");
            }
        }
